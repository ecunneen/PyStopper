...
2. Select the time that you will spend playing. Please note that the slider value is the maximum possible value for
playing time in seconds. The program will select a randomly chose time between 1 and the value of the slider. Ex. If you
choose 10 seconds you will be playing for a time between 1-10 seconds.
3. Set the value for the time stopped. It works in the same way as the time playing slider.
...
If you have any comments, questions, or features you would like to see please feel free to email Ed at ecunneen@asu.edu.


This file has been released under the MIT license. It is open source!